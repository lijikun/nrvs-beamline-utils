...
gnuplot --persist -e 'set ytics nomirror; set xlabel "Energy ('${unitString}')"; plot "'${intfile}'" using 1:2:3 with yerrorbars axis x1y1 title "'${string2}' PVDOS", "'${intfile}'" using 1:4 with lines axis x1y2 title "Integral"'
